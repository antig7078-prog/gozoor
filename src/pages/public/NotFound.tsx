    ...
    return (
        <div className="min-h-screen bg-brand-bg relative flex items-center justify-center overflow-hidden font-sans" dir="rtl">
            ...
            <div className="absolute inset-0 z-0">
                ...
                <div className="absolute bottom-[-10%] left-[-10%] w-[35rem] h-[35rem] bg-brand-accent/10 rounded-full mix-blend-screen filter blur-[120px] opacity-40 animate-pulse" style={{ animationDelay: '2s' }} />
            ...
            <div className="max-w-2xl w-full text-center relative z-10 px-6">
                ...
                >
                    ...
                    <div className="relative mb-12">
                        ...
                        >
                            <img 
                                ...
                                loading="lazy"
                                className="w-64 h-64 mx-auto object-contain rounded-full shadow-[0_0_50px_rgba(29,122,133,0.3)] border-4 border-brand-primary/20 p-2 bg-brand-bg/50 backdrop-blur-sm"
                            />
                        </motion.div>
                    ...
                    >
                        <h1 className="text-9xl font-black text-brand-accent leading-none mb-4 tracking-tighter">
                            404
                        </h1>
                        <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                            هذه الصفحة تاهت في الجذور!
                        </h2>
                        <p className="text-brand-primary-light/60 text-lg font-medium mb-12 max-w-lg mx-auto leading-relaxed">
                ...
                >
                    ...
                    <Button
                        ...
                        onClick={() => navigate(-1)}
                        size="lg"
                        className="w-full sm:w-auto px-10 h-14 text-lg border-brand-primary/30 text-brand-primary-light hover:bg-brand-primary/10 backdrop-blur-md"
                    >
                        العودة للخلف
                ...
                <div className="mt-20 flex justify-center items-center gap-2 text-brand-primary-light/30 font-medium">
                    <Compass className="w-4 h-4 animate-spin-slow" />
                    <span>منصة جذور — 2026</span>
                </div>
            </div>
        </div>
    );

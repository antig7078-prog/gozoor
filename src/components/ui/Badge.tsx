...
interface BadgeProps {
  ...
  variant?: 'primary' | 'secondary' | 'success' | 'warning' | 'danger' | 'info' | 'premium';
  size?: 'sm' | 'md';
  className?: string;
}
...
export const Badge = ({
  ...
  const variants = {
    ...
    success: 'bg-brand-primary-light text-brand-primary-hover border-brand-primary/20',
  ...
  const sizes = {
    ...
    md: 'px-3 py-1 text-sm font-black'
  };
